...
import com.example.alohaandroid.utils.messagekit.RoundedImageView;
...
public class MessageHolders1 {
     ...
     */
    public MessageHolders1 setIncomingTextConfig(
     ...
     * @param holder holder class.
     */
    public MessageHolders1 setIncomingTextHolder(
            @NonNull Class<? extends BaseMessageViewHolder<? extends IMessage>> holder) {
        this.incomingTextConfig.holder = holder;
        return this;
    }
     ...
     * @param layout layout resource.
     */
    public MessageHolders1 setIncomingTextLayout(@LayoutRes int layout) {
        this.incomingTextConfig.layout = layout;
        return this;
    }
     ...
     * @param payload custom data.
     */
    public MessageHolders1 setIncomingTextLayout(@LayoutRes int layout, Object payload) {
        this.incomingTextConfig.layout = layout;
        this.incomingTextConfig.payload = payload;
        return this;
    }
     ...
     * @param layout layout resource.
     */
    public MessageHolders1 setOutcomingTextConfig(
            @NonNull Class<? extends BaseMessageViewHolder<? extends IMessage>> holder,
            @LayoutRes int layout) {
     ...
     * @param holder holder class.
     */
    public MessageHolders1 setOutcomingTextHolder(
            @NonNull Class<? extends BaseMessageViewHolder<? extends IMessage>> holder) {
        this.outcomingTextConfig.holder = holder;
        return this;
    }
     ...
     * @param layout layout resource.
     */
    public MessageHolders1 setOutcomingTextLayout(@LayoutRes int layout) {
        this.outcomingTextConfig.layout = layout;
        return this;
    }
     ...
     * @param payload custom data.
     */
    public MessageHolders1 setOutcomingTextLayout(@LayoutRes int layout, Object payload) {
        this.outcomingTextConfig.layout = layout;
        this.outcomingTextConfig.payload = payload;
        return this;
    }
     ...
     * @param layout layout resource.
     */
    public MessageHolders1 setIncomingImageConfig(
     ...
     * @param holder holder class.
     */
    public MessageHolders1 setIncomingImageHolder(
            @NonNull Class<? extends BaseMessageViewHolder<? extends MessageContentType.Image>> holder) {
        this.incomingImageConfig.holder = holder;
        return this;
    }
     ...
     * @param layout layout resource.
     */
    public MessageHolders1 setIncomingImageLayout(@LayoutRes int layout) {
        this.incomingImageConfig.layout = layout;
        return this;
    }
     ...
     * @param payload custom data.
     */
    public MessageHolders1 setIncomingImageLayout(@LayoutRes int layout, Object payload) {
        this.incomingImageConfig.layout = layout;
        this.incomingImageConfig.payload = payload;
        return this;
    }
     ...
     * @param layout layout resource.
     */
    public MessageHolders1 setOutcomingImageConfig(
            @NonNull Class<? extends BaseMessageViewHolder<? extends MessageContentType.Image>> holder,
            @LayoutRes int layout) {
     ...
     * @param holder holder class.
     */
    public MessageHolders1 setOutcomingImageHolder(
            @NonNull Class<? extends BaseMessageViewHolder<? extends MessageContentType.Image>> holder) {
        this.outcomingImageConfig.holder = holder;
        return this;
    }
     ...
     * @param layout layout resource.
     */
    public MessageHolders1 setOutcomingImageLayout(@LayoutRes int layout) {
        this.outcomingImageConfig.layout = layout;
        return this;
    }
     ...
     * @param payload custom data.
     */
    public MessageHolders1 setOutcomingImageLayout(@LayoutRes int layout, Object payload) {
        this.outcomingImageConfig.layout = layout;
        this.outcomingImageConfig.payload = payload;
        return this;
    }
     ...
     * @param layout layout resource.
     */
    public MessageHolders1 setDateHeaderConfig(
     ...
     * @param holder holder class.
     */
    public MessageHolders1 setDateHeaderHolder(@NonNull Class<? extends ViewHolder<Date>> holder) {
        this.dateHeaderHolder = holder;
        return this;
    }
     ...
     * @param layout layout resource.
     */
    public MessageHolders1 setDateHeaderLayout(@LayoutRes int layout) {
        this.dateHeaderLayout = layout;
        return this;
    }
    ...
    MessageHolders1 registerContentType(
    ...
    MessageHolders1 registerContentType(
            byte type,
            @NonNull Class<? extends MessageHolders1.BaseMessageViewHolder<TYPE>> incomingHolder, Object incomingPayload, @LayoutRes int incomingLayout,
            @NonNull Class<? extends MessageHolders1.BaseMessageViewHolder<TYPE>> outcomingHolder, Object outcomingPayload, @LayoutRes int outcomingLayout,
            @NonNull MessageHolders1.ContentChecker contentChecker) {

        if (type == 0)
            throw new IllegalArgumentException("content type must be greater or less than '0'!");

        customContentTypes.add(
                new MessageHolders1.ContentTypeConfig<>(type,
                        new MessageHolders1.HolderConfig<>(incomingHolder, incomingLayout, incomingPayload),
                        new MessageHolders1.HolderConfig<>(outcomingHolder, outcomingLayout, outcomingPayload)));
        this.contentChecker = contentChecker;
        return this;
    }
    ...
    protected void bind(final ViewHolder holder, final Object item, boolean isSelected,
                        ...
                        final SparseArray<MessagesListAdapter1.OnMessageViewClickListener> clickListenersArray) {

        if (item instanceof IMessage) {
            ((MessageHolders1.BaseMessageViewHolder) holder).isSelected = isSelected;
            ((MessageHolders1.BaseMessageViewHolder) holder).imageLoader = imageLoader;
            ...
            ((MessageHolders1.DefaultDateHeaderViewHolder) holder).dateHeadersFormatter = dateHeadersFormatter;
        }
    ...
    public static abstract class BaseMessageViewHolder<MESSAGE extends IMessage> extends ViewHolder<MESSAGE> {
        ...
        public boolean isSelectionModeEnabled() {
            return MessagesListAdapter1.isSelectionModeEnabled;
        }
        ...
        protected void configureLinksBehavior(final TextView text) {
            ...
            text.setMovementMethod(new LinkMovementMethod() {
                ...
                public boolean onTouchEvent(TextView widget, Spannable buffer, MotionEvent event) {
                    ...
                    if (!MessagesListAdapter1.isSelectionModeEnabled) {
