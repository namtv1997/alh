...
public class MessagesListAdapter1<MESSAGE extends IMessage>
    ...
    private MessageHolders1 holders;
     ...
     */
    public MessagesListAdapter1(String senderId, ImageLoader imageLoader) {
        this(senderId, new MessageHolders1(), imageLoader);
    }
     ...
     *
     * @param senderId    identifier of sender.
     * @param holders     custom layouts and view holders. See {@link MessageHolders1} documentation for details
     * @param imageLoader image loading method.
     */
    public MessagesListAdapter1(String senderId, MessageHolders1 holders,
    ...
    /**
     * This class is deprecated. Use {@link MessageHolders1} instead.
     */
    @Deprecated
    public static class HoldersConfig extends MessageHolders1 {
    ...
    public static abstract class BaseMessageViewHolder<MESSAGE extends IMessage>
            extends MessageHolders1.BaseMessageViewHolder<MESSAGE> {
    ...
    public static class DefaultDateHeaderViewHolder extends ViewHolder<Date>
            implements MessageHolders1.DefaultMessageViewHolder {
    ...
    public static class IncomingMessageViewHolder<MESSAGE extends IMessage>
            extends MessageHolders1.IncomingTextMessageViewHolder<MESSAGE>
            implements MessageHolders1.DefaultMessageViewHolder {
