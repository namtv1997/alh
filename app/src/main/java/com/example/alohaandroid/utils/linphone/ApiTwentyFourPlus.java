...
import static com.example.alohaandroid.utils.linphone.Compatibility.CHAT_NOTIFICATIONS_GROUP;
import static com.example.alohaandroid.utils.linphone.Compatibility.INTENT_ANSWER_CALL_NOTIF_ACTION;
import static com.example.alohaandroid.utils.linphone.Compatibility.INTENT_HANGUP_CALL_NOTIF_ACTION;
import static com.example.alohaandroid.utils.linphone.Compatibility.INTENT_LOCAL_IDENTITY;
import static com.example.alohaandroid.utils.linphone.Compatibility.INTENT_MARK_AS_READ_ACTION;
import static com.example.alohaandroid.utils.linphone.Compatibility.INTENT_NOTIF_ID;
import static com.example.alohaandroid.utils.linphone.Compatibility.INTENT_REPLY_NOTIF_ACTION;
import static com.example.alohaandroid.utils.linphone.Compatibility.KEY_TEXT_REPLY;
...
class ApiTwentyFourPlus {
    ...
    public static Notification createMessageNotification(
        ...
        return new Notification.Builder(context)
                ...
                .setShowWhen(true)
                .setColor(context.getColor(R.color.blue_dark))
                .setStyle(style)
